...
**Near-term priorities:** stakeholder-driven (CM, multi-squadron, password productization). Phases A–F done for demo scope (incl. responsive shell). Pi Tailscale demo: [deploy/pi/README.md](../../deploy/pi/README.md). Full list: [ROADMAP.md](../../ROADMAP.md).
